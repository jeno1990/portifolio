...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 py-20" id="home">
      <div className="max-w-6xl mx-auto w-full grid lg:grid-cols-[auto_1fr] gap-12 lg:gap-20 items-center">
        ...
        >
          <div className="flex flex-col gap-6">
            <SocialLink href={`https://${personalInfo.github}`} icon={<FaGithub size={22} />} />
            <SocialLink href={`https://${personalInfo.linkedin}`} icon={<FaLinkedin size={22} />} />
        ...
        <div className="space-y-8">
          ...
          >
            <p className="text-base md:text-lg text-foreground/70 leading-relaxed">
              I'm a software engineer who loves building elegant solutions to complex problems. 
              Specializing in full-stack development and machine learning, I turn ideas into reality. 
              Currently working at <span className="text-primary font-semibold">{currentCompany}</span>.
            </p>
          </motion.div>
          ...
          >
            <div className="font-mono text-xs text-foreground/30 space-y-1">
              ...
              <div className="pl-4">name: <span className="text-primary/80">"{personalInfo.name.split(" ")[0]}"</span>,</div>
              <div className="pl-4">skills: [<span className="text-primary/80">"Full Stack"</span>, <span className="text-primary/80">"ML"</span>, <span className="text-primary/80">"Cloud"</span>],</div>
              <div className="pl-4">passion: <span className="text-primary/80">"Building great products"</span></div>
              <div>{"}"}</div>
            </div>
          </motion.div>
        </div>
      ...
      >
        <span className="text-xs text-foreground/40 uppercase tracking-widest font-mono">Scroll</span>
